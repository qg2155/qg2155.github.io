...
We were given a csv file with several months worth of data collected from a patient's accelerometerdevice. The goal was to understand patterns of physical activity over long periods of time.
